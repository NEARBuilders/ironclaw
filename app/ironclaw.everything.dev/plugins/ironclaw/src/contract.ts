...
export const contract = oc.router({
  ...
  skills: {
    ...
    autoActivate: oc
      .route({
        method: "POST",
        path: "/skills/{name}/auto-activate",
        summary: "Toggle per-skill auto-activation",
      })
      .input(
        z.object({
          name: z.string(),
    ...
    autoActivateLearned: oc
      .route({
        method: "POST",
        path: "/skills/auto-activate-learned",
        summary: "Toggle learned skills auto-activation",
      })
    ...
    tools: {
      list: oc
        .route({
          method: "GET",
          path: "/settings/tools",
          summary: "List user-scoped tool settings",
        })
      ...
      set: oc
        .route({
          method: "POST",
          path: "/settings/tools",
          summary: "Set tools auto-approve toggle",
        })
        .input(z.object({ enabled: z.boolean() }))
        .output(z.object({ success: z.boolean() }))
        .errors(Errors),
      ...
      setPermission: oc
        .route({
          method: "POST",
          path: "/settings/tools/{capabilityId}",
          summary: "Set per-tool permission state",
        })
        .input(
          z.object({
            capabilityId: z.string(),
